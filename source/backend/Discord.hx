...
class DiscordClient
{
	...
	// this is the old ID incase i need it: 863222024192262205
	private inline static final _defaultID:String = "1424876780384292896";
	...
	public static function changePresence(details:String = 'In the Arcade', ?state:String, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float, largeImageKey:String = 'icon')
	{
